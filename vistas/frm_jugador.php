...
<table>
    <tbody>
        <tr>
            ...
            <th><input type="number" id="txt_cedula" name="txt_cedula" onkeypress='return event.charCode >= 48 && event.charCode <= 57;' onblur="validarDocumento(this.value);" maxlength="10"/></th>
